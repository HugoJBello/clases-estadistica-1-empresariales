...
realizar conteos de manera intuitiva teniendo en cuenta el siguiente truco.
...
Si queremos contar las \textbf{maneras posibles de formar números de 2 dígitos permitiendo repeticiones} podemos observar como 
...
Si queremos contar las \textbf{maneras posibles de formar números de 3 dígitos permitiendo repeticiones} la historia es similar
...
Otro caso es pensar en hacer esto pero sin repetir ningún dígito, es decir contar las \textbf{maneras posibles de formar números de 3 dígitos sin repeticiones}
...
En general hemos aprendido el siguente truco. Si tenemos un conjunto de $n$ elementos y tenemos que elegir $k$ importando el orden, lo que tendremos que hacer es:
...
En este caso estamos ante las combinaciones.
